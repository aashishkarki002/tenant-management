      ...
      <div className="relative" ref={filterPopoverRef}>
        <button
          ...
          className={cn(
            ...
            hasActiveFilters
              ? 'border-white text-white bg-primary hover:bg-primary/20'
        ...
        >
          ...
          Filter
          {hasActiveFilters && (
            <span className="flex h-4 w-4 items-center justify-center rounded-full  text-[10px] font-semibold text-primary">
        ...
        {/* Popover */}
        {filterPopoverOpen && (
          <div className="absolute right-0 top-[calc(100%+6px)] z-50 w-80 max-w-[calc(100vw-1rem)] max-h-[80vh] overflow-y-auto rounded-xl border border-muted-fill bg-background shadow-lg">
            {/* Header */}
            <div className="flex items-center justify-between px-3 py-3 border-b border-muted-fill sticky top-0 bg-background z-10">
