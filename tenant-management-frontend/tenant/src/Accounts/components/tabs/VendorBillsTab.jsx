      ...
      <div className="w-full max-w-md rounded-2xl bg-[var(--color-surface-raised)] p-6 shadow-xl border border-[var(--color-border)]">
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <div>
            ...
            <select className="w-full border border-[var(--color-border)] rounded-lg px-3 py-1.5 text-sm bg-[var(--color-surface)] text-[var(--color-text)]"
                  ...
                  <tr key={b._id} className="border-b border-[var(--color-border)]/30 hover:bg-[var(--color-surface-hover)] transition-colors">
                    ...
                    <td className="py-2">
                      {b.status !== "PAID" && b.status !== "CANCELLED" && (
                        <button onClick={() => setPayingBill(b)} className="text-xs px-3 py-1 rounded-lg border border-[var(--color-primary)] text-[var(--color-primary)] hover:bg-[var(--color-primary)] hover:text-white transition-colors">
                          Pay
                        </button>
                      )}
                    </td>
